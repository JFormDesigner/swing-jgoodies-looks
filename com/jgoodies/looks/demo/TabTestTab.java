...
import com.jgoodies.swing.panels.SimpleInternalFrame;
...
final class TabTestTab {
    ...
    private JComponent buildHorizontalSplit() {
        return UIFactory.createStrippedSplitPane(
    ...
    private JComponent buildNavigationPanel() {
        ...
        tabbedPane.addTab("Tree", UIFactory.createStrippedScrollPane(buildTree()));
        tabbedPane.addTab("Help", UIFactory.createStrippedScrollPane(buildHelp()));
